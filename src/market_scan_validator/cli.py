"""CLI entry point for Market Scan Phase 0 Leading Edge Validator."""
...
from market_scan_validator.classifier import Thresholds, Verdict, classify
from market_scan_validator.data_fetcher import DataFetcher
from market_scan_validator.excess_return import (
    average_window_returns,
    compute_window_returns,
)
from market_scan_validator.report import (
    CaseResult,
    TickerResult,
    TriggerResult,
    ValidatorRun,
...
def main(argv: list[str] | None = None) -> int:
    ...
    p = argparse.ArgumentParser(description="Market Scan Phase 0 — Leading Edge Validator")
    p.add_argument(
        "--config",
        type=Path,
