...
from polydig_mcp.reviewer.schema import REVIEW_JSON_SCHEMA
...
SCOUT_SYSTEM = f"""你是 PolyDig 的 Scout(偵察)agent,模型 Claude Haiku 4.5。
...
REVIEWER_SYSTEM = f"""你是 PolyDig 的 Reviewer(審查)agent,模型 Claude Sonnet 4.6。
