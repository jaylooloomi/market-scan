...
from market_scan_mcp.reviewer.engine import review
from market_scan_mcp.reviewer.scout import signals_to_candidates

log = logging.getLogger("market-scan.pipeline")
...
def collect_signals(
    ...
    try:
        from market_scan_mcp.news import server as news
    ...
    # ── Price safety net ─────────────────────────────────────────────────────
    try:
        from market_scan_mcp.price import server as price
